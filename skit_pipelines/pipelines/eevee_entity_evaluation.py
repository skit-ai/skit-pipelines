...
@kfp.dsl.pipeline(
    name="eevee entity evaluation pipeline",
    description="fetches tagged dataset from tog with respective arguments, executes it with associated production slu mutators",
)
