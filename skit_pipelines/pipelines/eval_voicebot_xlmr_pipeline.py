...
def run_xlmr_eval(*,
    ...
    preprocess_data_op = create_utterances_op(tagged_data_op.outputs["output"]).after(check1)
    # preprocess_data_op.execution_options.caching_strategy.max_cache_staleness = (
    #     "P0D"  # disables caching
    # )
    
    # moving logic of extract_tgz_op into get_preds_voicebot_xlmr_op as Amresh noticed the
    # movement of file between the 2 components gets really slow.
    # extracted_model_op = extract_tgz_op(loaded_model_op.outputs["output"]).after(check2)
    # extracted_model_op.execution_options.caching_strategy.max_cache_staleness = (
    #     "P0D"  # disables caching
    # )
