...
def upload2sheet(
    ...
    try:
        ...
        output_dict["notification_text"] = f"""Uploaded {output_dict["num_calls_uploaded"]} {language_code} language calls from flow_name: {flow_name} for date: {today_str} to {output_dict["spread_sheet_url"]} """
